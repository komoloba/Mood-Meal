...
enum class MoodDim {
    valence, arousal, stress, craving, bodysense
}
...
@Serializable
data class QuestionsList(val questions: List<MoodQuestion>)

@Serializable
data class RecipesList(val recipes: List<Recipe>)

@Serializable
data class MarketRestaurantData(
